  ...
  return (
    <div className="h-screen flex flex-col text-white selection:bg-white/30 selection:text-white overflow-hidden" style={{ background: '#09090B' }}>
      ...
      >
        ...
        <svg viewBox="0 0 24 24" fill="white" className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 relative z-10">
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-4 left-4 z-50 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-white/[0.05] border border-blue-500/20 backdrop-blur-md flex items-center justify-center shadow-lg shadow-black/20 hover:bg-blue-600/10 hover:border-blue-500/40 hover:scale-110 transition-[background,border-color,transform,opacity] duration-500 ${
          showBackToTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'
        }`}
        aria-label="Volver arriba"
      >
        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      >
        ...
        <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 relative z-10">
