  ...
  return (
    <div className="min-h-screen flex flex-col text-white selection:bg-white/30 selection:text-white" style={{ background: '#09090B' }}>
      ...
      <a
        ...
        className="fixed bottom-24 right-6 z-50 w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 group"
        style={{ background: 'linear-gradient(135deg, #833AB4 0%, #FD1D1D 50%, #F77737 100%)' }}
        aria-label="Instagram @bs.digitaltech"
      >
        <span className="absolute inset-0 rounded-full opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-500" style={{ background: 'linear-gradient(135deg, #833AB4, #FD1D1D, #F77737)' }} />
      ...
      <button
        ...
        className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-5 sm:px-7 py-2.5 sm:py-3 rounded-full bg-blue-600/90 backdrop-blur-md text-white font-semibold text-xs sm:text-sm shadow-lg shadow-blue-600/20 border border-blue-400/20 hover:bg-blue-500 hover:shadow-xl hover:shadow-blue-600/30 hover:border-blue-400/30 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2.5 whitespace-nowrap ${
          showBackToTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'
        }`}
