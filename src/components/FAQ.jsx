...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-16 sm:py-20 px-4 sm:px-6 border-t border-white/5" style={{ background: '#09090B' }}>
      <div className="max-w-3xl mx-auto">
              ...
              <Reveal key={i} animation="fade-up" delay={40}>
                <div className={`group rounded-2xl border transition-[border-color,background] duration-400 ${
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-out ${
                    ...
                    <p className="px-5 pb-4 text-sm text-[#A1A1AA] leading-relaxed pl-12">
                      {item.r}
                    </p>
                  </div>
                </div>
        ...
        <Reveal animation="fade-up" delay={120} className="text-center mt-10">
          <p className="text-[#A1A1AA] text-sm mb-4">¿Tienes otra pregunta?</p>
          <a
            href={WHATSAPP_FULL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors font-medium group"
          >
