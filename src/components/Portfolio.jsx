          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {proyectos.map((proj, i) => (
              <Reveal key={proj.id} animation="fade-up" delay={i * 80}>
                <TiltCard>
                <div className="group relative bg-white/[0.02] border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm md:backdrop-blur-lg transition-[transform,border-color,box-shadow] duration-500 hover:-translate-y-2 hover:border-white/[0.12] hover:shadow-xl hover:shadow-white/[0.03] h-full flex flex-col">
                  <a
                    href={proj.url}
                    target="_blank"
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {(proj.tags || []).map((tag) => (
                        <span
                          key={tag}
                          className="text-[10px] font-medium text-white/60 bg-white/[0.03] border border-white/[0.06] px-2 py-0.5 rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
